...
import com.example.easypay.presentation.common.TwoLinesText
...
@Composable
fun ResultScreen(resultModelList: List<Pair<String, String>>, onFinishClick: () -> Unit) {
    Column() {
